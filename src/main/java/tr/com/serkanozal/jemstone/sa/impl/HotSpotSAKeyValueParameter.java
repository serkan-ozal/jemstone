...
public class HotSpotSAKeyValueParameter implements HotSpotServiceabilityAgentParameter {
    
    private final Map<String, Serializable> keyValueMap = new HashMap<String, Serializable>();
    
    public HotSpotSAKeyValueParameter addParameter(String key, Serializable value) {
    ...
    public String toString() {
        return "HotSpotSAKeyValueParameter [" + keyValueMap + "]";
    }
